...
describe("determineRenameOperation", () => {
  ...
  it("handles empty current path", () => {
    const result = determineRenameOperation("", "file.txt", "folder", "file.txt", ALLOWED_EXTENSIONS, []);
  ...
  it("handles empty new path", () => {
    const result = determineRenameOperation("folder", "file.txt", "", "file.txt", ALLOWED_EXTENSIONS, []);
